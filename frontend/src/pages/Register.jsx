    ...
    <div className="pt-28 flex justify-center px-4">
      <form onSubmit={submit} className="w-full max-w-md bg-white dark:bg-gray-800 p-8 rounded-xl shadow">
        ...
        <input
          ...
          placeholder="Nombre"
          className="w-full p-3 rounded-lg border mb-3 bg-gray-50 dark:bg-gray-700"
          required
        />
        <input
          value={email}
          ...
          required
        />
        <button className="w-full py-3 bg-indigo-600 text-white rounded-lg">Registrarme</button>
      </form>
    </div>
  );
}
